...
async def start_message(c,m):
    ...
    await m.reply_photo(f"https://envs.sh/pU.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                InlineKeyboardButton('💝 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/af_back_up')
            ],[
                InlineKeyboardButton("❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ", url='https://t.me/af_mhakal'),
                InlineKeyboardButton("🤖 ᴜᴘᴅᴀᴛᴇ", url='https://t.me/+OiKmB79YlMJmNTJl')
            ]]
        )
    )
...
async def approve_new(client, m):
    ...
    try:
        ...
        try:
            await client.send_message(m.from_user.id, "**Hello {}!\nWelcome To {}\n\n__Powered By : @af_mhakal __**".format(m.from_user.mention, m.chat.title))
        except:
            pass
    except Exception as e:
        print(str(e))
